...
namespace Native.App.Export
{
	...
	{	
		...
		/// <para>Id: 100020</para>	
		/// <para>Type: 2</para>	
		/// <para>Name: [群消息]正则检测冒号乎叫命令菜单</para>	
		/// <para>Function: _eventGroupMsg_menu</para>	
		/// <para>Priority: 20000</para>	
		/// <para>IsRegex: True</para>	
		/// </summary>	
		public static event EventHandler<CQGroupMessageEventArgs> Event_eventGroupMsg_menuHandler;	
		[DllExport (ExportName = "_eventGroupMsg_menu", CallingConvention = CallingConvention.StdCall)]	
		public static int Event_eventGroupMsg_menu (int subType, int msgId, long fromGroup, long fromQQ, string fromAnonymous, IntPtr msg, int font)	
		{	
		...
		/// <para>Id: 100030</para>	
		/// <para>Type: 2</para>	
		/// <para>Name: [群消息]独立命令:我很可爱请给我钱</para>	
		/// <para>Function: _eventGroupMsg_master</para>	
		/// <para>Priority: 20000</para>	
		/// <para>IsRegex: True</para>	
		/// </summary>	
		public static event EventHandler<CQGroupMessageEventArgs> Event_eventGroupMsg_masterHandler;	
		[DllExport (ExportName = "_eventGroupMsg_master", CallingConvention = CallingConvention.StdCall)]	
		public static int Event_eventGroupMsg_master (int subType, int msgId, long fromGroup, long fromQQ, string fromAnonymous, IntPtr msg, int font)	
		{	
