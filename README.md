...
[Native 维基](/Jie2GG/Native.Framework/wiki) <br/>
同时包括了 Native.SDK 的安装方法、编程规范、编译部署及常见错误和解决方案

# 更新日志

[Native 更新日志](README.me)

# 关于打赏

您的支持就是我更新的动力!

<img src="https://native-1251169624.cos.ap-hongkong.myqcloud.com/Native_AliPay.png" alt="支付宝二维码" width="260" height="350"><img src="https://s2.ax1x.com/2020/02/09/1fvB8A.png" alt="微信二维码" width="260" height="350">
