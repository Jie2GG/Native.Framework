...
namespace Native.Csharp.App.EventArgs
{
	...
	public class CqAddGroupRequestEventArgs : CqEventArgsBase
	{
		...
		/// 获取一个值, 该值表示当前事件的名称
		/// </summary>
		public override string Name { get { return "添加群请求"; } }
        ...
        public CqAddGroupRequestEventArgs (int id, DateTime sendTime, long fromGroup, long fromQQ, string message, string flag)
		{
			this.Id = id;
