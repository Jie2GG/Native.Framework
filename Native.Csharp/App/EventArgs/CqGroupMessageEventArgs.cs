...
namespace Native.Csharp.App.EventArgs
{
    ...
    public class CqGroupMessageEventArgs : CqEventArgsBase
    {
        ...
        /// 获取一个值, 该值表示当前事件的名称
        /// </summary>
        public override string Name { get { return "群消息"; } }
        ...
        public CqGroupMessageEventArgs (int id, int msgId, long fromGroup, long fromQQ, GroupAnonymous anonymous, string msg)
        {
            this.Id = id;
            this.MsgId = msgId;
